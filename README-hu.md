...
A Neuron OS egy **capability-alapú aktor runtime** .NET-re, egyetlen egyszerű elvre építve:
...
Ma a Neuron OS **bármely .NET hoszton** (Windows, Linux, macOS) fut referencia runtime-ként. Holnap natívan fog futni a **Cognitive Fabric Processing Unit (CFPU)** hardveren — egy új kategóriájú feldolgozó egységen, ahol minden core **fizikailag egy aktor**, saját privát SRAM-mal és hardveres mailbox FIFO-kkal.
...
A Neuron OS három okból kapott önálló repót:
...
A Neuron OS **bármely** CIL hoszton fut. A hardveres co-design céljából **kiegészítésként** a Neuron OS workload-okat a CLI-CPU referencia szimulátoron is futtatjuk (a hamarosan érkező `FenySoft.CilCpu.Sim` NuGet csomagon át), hogy felfedezzük a hardveres követelményeket:
