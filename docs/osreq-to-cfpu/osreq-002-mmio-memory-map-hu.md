...
A .NET referencia implementációban nincs MMIO — a `TActorSystem` közvetlenül kezeli a belső állapotot. A boot szekvencia kódja (`src/NeuronOS.Boot/`) még nem létezik.
...
- Neuron OS boot sequence: `docs/boot-sequence-hu.md` — 1–8. lépés
